...
PubSocket.prototype.connect = function(destination, durable, callback) {
  ...
  ch.assertExchange(destination,
                    ...
                    {durable: durable, autoDelete: this.options.autoDelete || false})
    .then(function(ok) {
...
function SubSocket(channel, opts) {
  ...
  var setup = channel.then(function(ch) {
    return ch.assertQueue(opts.queueName || '', {
      exclusive: opts.exclusive || false, autoDelete: opts.autoDelete || false, durable: opts.persistent || false
    }).then(function(ok) {
      ...
      }, {noAck:true, exclusive: opts.exclusive || false})
...
function ReqSocket(channel, opts) {
  ...
  var setup = channel.then(function(ch) {
    return ch.assertQueue(opts.queueName || '', {exclusive: opts.exclusive ||  false, autoDelete: opts.autoDelete || false})
      .then(function(ok) {
